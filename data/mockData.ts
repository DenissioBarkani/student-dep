...
export const mockCompanies: CompanyProps[] = [
  {
    id: 1,
...
export const getPaginatedCompanies = (page: number, perPage: number = 12) => {
  ...
  return {
    ...
    pages: Math.ceil(mockCompanies.length / perPage),
    items: mockCompanies.length,
  };
};
